...
namespace DogOwnerTracker.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OwnerID,FirstName,LastName,Address,City,State,ZipCode")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OwnerID,FirstName,LastName,Address,City,State,ZipCode")] Owner owner)
        {
            if (id != owner.OwnerID)
            {
                return NotFound();
